...
const Login = () => {
  ...
  const notifier = useEditor((store) => store.notifier);

  const height = useEditor((store) => store.height);
  ...
  const setUserPreference = useEditor((store) => store.setUserPreference);
  const userPreference = useEditor((store) => store.userPreference);
    ...
    >
      ...
      <Button
        ...
        onClick={() => {
          setUserPreference({
            ...userPreference,
            netstats: userPreference?.netstats ?? false,
            authstats: false,
          });
          navigate("/");
        }}
